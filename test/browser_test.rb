...
class BrowserTest < Test::Unit::TestCase
  ...
  CHROME_FRAME   = "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; chromeframe/11.0.660.0)"
  ...
  def test_detect_chrome_frame
    @browser.ua = CHROME_FRAME
    ...
    assert_equal "11.0.660.0", @browser.full_version
    assert_equal "11", @browser.version
  end
